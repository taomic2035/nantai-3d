...
- [x] **Step 3: Add the minimal normalization and derivation**
...
- [x] **Step 5: Commit and push the scheduler contract**
...
- [x] **Step 1: Write failing layer and HUD contract tests**
...
- [x] **Step 3: Store request evidence and expose a fail-closed summary**
...
- [x] **Step 4: Run focused and complete Viewer verification**
...
- [x] **Step 5: Commit and push the observable density state**
...
- [x] **Step 1: Write the acceptance evidence**
...
- [x] **Step 2: Verify the final scoped diff**
...
- [x] **Step 3: Commit and push the handoff receipt**
